...
<%@page import="entity.OrderStatus" %>
<%@page import="entity.ReviewStatus" %>
...
<jsp:useBean id="orderDetailsList" class="java.util.ArrayList" scope="request" type="java.util.List<entity.OrderDetails>" />
<!DOCTYPE html>
<html>
    <head>
        <meta charset="UTF-8" />
            ...
            <div class="content" id="order-history-content" style="display: none;">
                ...
                <table class="history-table">
                    ...
                    <tbody>
                        ...
                        %>
                        <tr>
                            <td><p class="order-id"><%= details.getOrderId() %></p></td>
                            <td><p class="date"><%= details.getPaidDate() %></p></td>
                            <td><p class="time"><%= details.getPaidTime() %></p></td>
